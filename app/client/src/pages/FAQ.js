        ...
        <div className='static-body static-html'>
          ...
          <div id="loginPane">
            ...
            <div className="container-fluid static-container-fluid py-5">
              ...
              {false && (<p style={{color: 'rgb(0,0,0)', fontSize: '18px'}}>&nbsp; &nbsp;4. What if I want to play with the same person at a later date?<br />You are able to add other users as friends and be able to queue with them in the future.</p>)}
            </div>
          </div>
